            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            @if (session()->has('error'))
                                <i><b style="color:red">{{ session()->get('error') }}</b></i>
                            @endif
                            <form method="POST" action="{{ route('admin.reset-password.send') }}" class="needs-validation" novalidate="">
                                @csrf
                                <div class="form-group">
                                    <label for="email">User</label>
                                    <input id="email" type="email" value="{{ request()->email }}" class="form-control" name="email" tabindex="1" required autofocus>
                                    <input type="hidden" value="{{ $token }}" class="form-control" name="token" tabindex="1" required autofocus>
                    ...
                    <div class="simple-footer">
                        Copyright &copy; Cales Junes 2023
                    </div>
                </div>
            </div>
        </div>
