                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('password.store') }}">
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="email" value="{{ old('email', $request->email) }}" placeholder="{{ __('frontend.Email') }}"
                                           type="text">
                                    @error('email')
                                ...
                                <div class="form-group">
                                    <button type="submit"
                                            class="btn btn-primary btn-block"> {{ __('frontend.Reset') }} </button>
                                </div>
                            </form>
                        </div>
                    </div>
